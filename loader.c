...
/*                                                                             */
/* Craig Schulstad - Horace, ND, USA (20 August, 2020)                         */
/*                                                                             */
...
HRSRC WINAPI DECLSPEC_HOTPATCH FindResourceExW( HMODULE module, LPCWSTR type, LPCWSTR name, WORD lang )
{
    ...
    /* resources that have a type value that was generated by MAKEINTRESOURCE.  Note that when utilizing */
    /* the GetMUI function call, any language neutral resources that reside in the excutable file such   */
    /* as icons might be ignored.  However, this usually will not have any effect on the functionality   */
